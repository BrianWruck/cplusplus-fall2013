...
void init() 
{
   ...
   cubes.add(Cube(1, 6, 1, Quad::BLUE));
   cubes.add(Cube(2, 5, 1, Quad::BLUE));
   cubes.add(Cube(3, 4, 1, Quad::BLUE));
   cubes.add(Cube(4, 3, 1, Quad::BLUE));
   cubes.add(Cube(5, 2, 1, Quad::BLUE));
   cubes.add(Cube(6, 1, 1, Quad::BLUE));
   cubes.add(Cube(0, 6, 1, Quad::RED));
   ...
   //right
    ...
    cubes.add(Cube(-1, 6, 1, Quad::GREEN));
   cubes.add(Cube(-2, 5, 1, Quad::GREEN));
   cubes.add(Cube(-3, 4, 1, Quad::GREEN));
   cubes.add(Cube(-4, 3, 1, Quad::GREEN));
   cubes.add(Cube(-5, 2, 1, Quad::GREEN));
   cubes.add(Cube(-6, 1, 1, Quad::GREEN));
